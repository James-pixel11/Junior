...
namespace CalculatorShop {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataDataTable : global::System.Data.TypedTableBase<EmployeeDataRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeDataRow AddEmployeeDataRow(string Username, string FirstName, string LastName, string Password) {
...
namespace CalculatorShop.Database1DataSetTableAdapters {
    ...
    public partial class EmployeeDataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `EmployeeData` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `EmployeeData` (`Username`, `FirstName`, `LastName`, `Password`) VALU" +
                "ES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `EmployeeData` SET `Username` = ?, `FirstName` = ?, `LastName` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CalculatorShop.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Username, FirstName, LastName, [Password] FROM EmployeeData";
        ...
        public virtual int Fill(Database1DataSet.EmployeeDataDataTable dataTable) {
        ...
        public virtual Database1DataSet.EmployeeDataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.EmployeeDataDataTable dataTable = new Database1DataSet.EmployeeDataDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.EmployeeDataDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Username, string Original_FirstName, string Original_LastName, string Original_Password) {
        ...
        public virtual int Update(string Username, string FirstName, string LastName, string Password, int Original_ID, string Original_Username, string Original_FirstName, string Original_LastName, string Original_Password) {
            if ((Username == null)) {
